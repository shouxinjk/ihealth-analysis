...
public abstract class AbstractCheckupBolt extends BaseRichBolt {
    private static final Logger LOG = LoggerFactory.getLogger(AbstractCheckupBolt.class);
    ...
    public AbstractCheckupBolt(ConnectionProvider connectionProvider) {
